...
function ElectricBarGraph({ }) {
    ...
    const graphData = electricStationsData.map((electricStation) => ({
        rashut: electricStation.ELEC_STATION_NAME, count: parseInt(
            statecalc(
                mode,
    ...
    return (
        ...
        >
            <VerticalBarChart data={graphData} xAxisLabel="תחנת כוח" yAxisLabel="נפשות" subTitle="תושבים" subLabel="כמות" />
        </GraphFrame>
    );
}
